-- OPERATIONAL LEGACY-DATABASE BOOTSTRAP COPY
--
-- Use this file only for the reviewed manual bootstrap of a legacy database.
-- In this specific environment it must run before migrations
-- 202608010001_reservation_platform.sql and 202608010002_admin_dashboard_mvp.sql.
-- Do not run it again without first inspecting and recording the current database
-- state. The normal 202608020001 migration remains idempotent and must stay in the
-- regular migration history as migration 003.
--
